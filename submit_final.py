...
class DealData:
    def __init__(self):
        ...
        # print(list(self.df1.columns))
        self.df = pd.read_csv('Demo_Data.csv', dtype=str, parse_dates=['timestamp'], date_parser=date_parse)
        # print(self.df == pd.DataFrame())
        ...
        for i in col_list:
            ...
            #     self.df1 = self.df1[self.df1['%s' % i] == cc]
                ...
                if ',' in bb:
                    ...
                    self.df1 = self.df1[self.df1['%s' % i] > bb.split('>')[1]]
                elif '<' in bb:
                    self.df1 = self.df1[self.df1['%s' % i] < bb.split('<')[1]]
